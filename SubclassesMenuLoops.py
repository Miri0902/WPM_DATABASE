...
class WorkManagementSystem:
    ...
    #
    #         if choice == '1':
    #             view_projects_instance = ViewExistingProject(self.db_filename)
    #             view_projects_instance.view_existing_project()
    #
    #         elif choice == '2':
    #             if self.team_members_instance.role == "SuperAdmin":
    #                 project_id_to_update = input("Enter the ProjectID you want to update: ")
    #                 update_project_instance = UpdateProject(self.team_members_instance, self.db_filename)
    #                 update_project_instance.update_project(project_id_to_update)
    #             else:
    #                 print("You are not authorised to update projects.")
    #
    #         elif choice == '3':
    ...
    #             if self.team_members_instance.role == "SuperAdmin":
    #                 view_users_instance = ViewUsers(self.db_filename)
    #                 users_data = view_users_instance.view_users()
    #
    #                 if users_data:
    #                     update_users_instance = UpdateExistingUsers(self.db_filename)
    #                     update_users_instance.update_existing_user(users_data)
    #             else:
    #                 print("You are not authorised to update users.")
    #
    #         elif choice == '5':
    #             register_user_instance = RegisterUser(self.db_filename)
    #             register_user_instance.execute()
    #
    #         elif choice == '6':
    #             print("Exiting the Work Management System. Goodbye!")
    #             break
    #
    #         else:
